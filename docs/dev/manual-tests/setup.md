...
| [`phase-9.md`](phase-9.md) | Notebook controller registration, real execution, interrupt/busy, session sharing with Run File — phases 9a–9b |
| `phase-10.md` … `phase-12.md` | Stubs — no manual tests yet, these phases have not started |
