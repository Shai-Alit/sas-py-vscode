...
**6d-ii (recycle bin) is code-complete 2026-09-10** —
...
from 6c-i. `npm run verify` green (1549 unit; coverage 95.49 / 95.40 / 95.18 /
95.49), 333 integration, `npm run check:docs` green.
