...
6e (folder `resourceUri` fix + Cut/Paste, found live-testing 6c-ii during the
checkpoint, not yet reviewed or merged) — see the Phase index row and
