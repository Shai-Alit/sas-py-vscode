...
- **7c-ii (table properties/columns static viewer) is code-complete
  ...
  the right shape for it, not this slice. Full account in `phase-7.md`'s
  7c-ii Runbook entry.
